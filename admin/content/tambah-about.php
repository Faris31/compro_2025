...
if (isset($_GET['delete'])) {
    $id = $_GET['delete'];
    $queryGambar = mysqli_query($koneksi, "SELECT id, images FROM about WHERE id='$id'");
    $rowGambar = mysqli_fetch_assoc($queryGambar);
    $image_name = $rowGambar['images'];
    unlink("about/" . $image_name);
...
if (isset($_POST['simpan'])) {
    ...
    if ($id) {
        ...
        $insert = mysqli_query($koneksi, "INSERT INTO about (title, content, images, is_active) VALUES('$title','$content','$image_nama','$is_active')");
        if ($insert) {
                ...
                <div class="card-body">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class=" mb-3">
                            ...
                            <textarea name="content" id="summernote" class="form-control"><?= ($id) ? $rowEdit['content'] : '';  ?></textarea>
                        </div>
                        <div class="mb-3">
                            ...
                            <img class="mt-2 rounded-2" src="about/<?= (isset($rowEdit['images'])) ? $rowEdit['images'] : '' ?>" alt="" width="20%">
                        </div>
                        <div class=" mb-3">
